      ...
      <div className="section-shell relative">
        <div className="mb-4 flex items-end justify-between gap-3">
          <div>
            ...
            <h2 className="mt-2 text-xl font-semibold leading-tight sm:text-2xl">찬미 방송국</h2>
          </div>
          <a
            href={site.links.chzzk}
            target="_blank"
            rel="noopener noreferrer"
            className="focus-ring hidden min-h-8 items-center gap-2 rounded-lg bg-cherry px-3 text-xs font-semibold text-paper shadow-glow sm:inline-flex"
          >
          ...
          >
            <div className="relative min-h-[300px] overflow-hidden rounded-lg bg-rosewash">
              ...
              <div className="absolute left-3 top-3 flex flex-wrap gap-1.5">
                ...
                <span className="inline-flex min-h-7 items-center gap-1.5 rounded-lg bg-paper/95 px-2 text-[10px] font-semibold text-cherry">
                  <Mic2 aria-hidden className="h-3.5 w-3.5" />
                  TALK / NYAM / COS
                </span>
              </div>
              <div className="absolute bottom-3 left-3 right-3">
                <p className="text-[10px] font-semibold text-paper/75">NOW STREAMING</p>
                <h3 className="mt-1 line-clamp-2 max-w-xl text-2xl font-semibold leading-tight text-paper">{main?.title || '나는 찬미 라이브'}</h3>
              </div>
            ...
            <div className="mt-2 grid gap-2 lg:ml-2 lg:mt-0">
              ...
              <div className="rounded-lg bg-cherry p-2 text-paper shadow-glow">
                <p className="text-[10px] font-semibold text-paper/75">DONATION HEART</p>
                <p className="mt-1 text-sm font-semibold">방송 텐션 올라가는 순간</p>
              </div>
            </div>
          </a>
          ...
          <div className="grid gap-2">
            ...
            <div className="stream-panel rounded-lg border border-cherry/20 bg-paper/95 p-3 shadow-lift">
              <div className="mb-2 flex items-center justify-between">
                <p className="text-[10px] font-semibold text-cherry">STREAM DECK</p>
